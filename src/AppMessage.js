...
class AppMessage extends React.Component {
   constructor(props) {
		super(props);		
		console.log("this.props.severity " + this.props.severity + " this.props.message " + this.props.message);
	}					

    render() {		
		console.log ("In AppMessage : state message " + this.props.message + " "  + this.props.severity);
